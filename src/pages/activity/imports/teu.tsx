...
export default function TEUImport() {
  const fileInputRef =
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          result?.error ||
            responseText ||
            `The TEU import failed with status ${response.status}.`,
        )
      }
      ...
      setImportMessage(
        result?.message ||
          "TEU activity data imported successfully.",
      )
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Import TEU activity hours by Discord ID.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                The TEU activity import should contain a
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Paste the TEU activity spreadsheet data below.
                </p>
              </div>
...
987654321098765432, 8`}
          ...
          >
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Upload a TEU activity spreadsheet or data file.
              </p>
            </div>
