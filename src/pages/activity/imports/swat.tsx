...
export default function SWATImport() {
  const fileInputRef =
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          result?.error ||
            responseText ||
            `The SWAT import failed with status ${response.status}.`,
        )
      }
      ...
      setImportMessage(
        result?.message ||
          "SWAT activity data imported successfully.",
      )
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Import SWAT activity hours by Discord ID.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                The SWAT activity import should contain a
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Paste the SWAT activity spreadsheet data below.
                </p>
              </div>
...
987654321098765432, 8`}
          ...
          >
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Upload a SWAT activity spreadsheet or data file.
              </p>
            </div>
