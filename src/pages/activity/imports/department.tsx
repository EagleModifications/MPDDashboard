    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          result?.error ||
            responseText ||
            `The Department import failed with status ${response.status}.`,
        )
      }
      ...
      setImportMessage(
        result?.message ||
          "Department activity data imported successfully.",
      )

      /* Clear imported data from the input boxes */
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Import Department activity hours by Discord ID.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Paste the Department activity spreadsheet data below.
                </p>
              </div>
...
987654321098765432, 8`}
          ...
          >
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Upload a Department activity spreadsheet or data file.
              </p>
            </div>
