...
export default function TRUImport() {
  const fileInputRef =
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          result?.error ||
            responseText ||
            `The TRU import failed with status ${response.status}.`,
        )
      }
      ...
      setImportMessage(
        result?.message ||
          "TRU activity data imported successfully.",
      )
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Import TRU activity hours by Discord ID.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                The TRU activity import should contain a
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Paste the TRU activity spreadsheet data below.
                </p>
              </div>
...
987654321098765432, 8`}
          ...
          >
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Upload a TRU activity spreadsheet or data file.
              </p>
            </div>
