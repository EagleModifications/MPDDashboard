...
export default function TEURequirements() {
    ...
    async function load() {
      try {
        ...
        const requirementResponse =
          await fetch(
            "/config/requirements/activity/teu.json",
            {
              cache: "no-store",
            },
          )
          ...
          >
            ...
            >
              ...
              <p className="mt-2 max-w-md text-sm leading-6 text-muted-foreground">
                ...
                for TEU yet. Add ranks to the
                TEU rank configuration before
