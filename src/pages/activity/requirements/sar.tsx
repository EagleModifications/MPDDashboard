...
export default function SARRequirements() {
    ...
    async function load() {
      try {
        ...
        const requirementResponse =
          await fetch(
            "/config/requirements/activity/sar.json",
            {
              cache: "no-store",
            },
          )
          ...
          >
            ...
            >
              ...
              <p className="mt-2 max-w-md text-sm leading-6 text-muted-foreground">
                ...
                for SAR yet. Add ranks to the
                SAR rank configuration before
